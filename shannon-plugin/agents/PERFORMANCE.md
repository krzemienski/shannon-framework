...
capabilities:
  ...
  - "Coordinate with wave execution using SITREP protocol for multi-agent performance development"
  - "Load complete project context via Serena MCP before performance tasks"
